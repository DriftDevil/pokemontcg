...
export async function POST(request: NextRequest) {
  if (!EXTERNAL_API_BASE_URL) {
    console.error('[API /user/collection/cards/remove] External API base URL not configured.');
  ...
  const externalUrl = `${EXTERNAL_API_BASE_URL}/user/collection/cards/remove`;
