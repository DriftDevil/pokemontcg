...
export async function GET(request: NextRequest) {
  if (!EXTERNAL_API_BASE_URL) {
    console.error(`[API /admin/collections/cards] External API base URL not configured.`);
  ...
  console.log(`[API ${request.nextUrl.pathname}] Forwarding get all users' collections request to external API: ${externalUrl}`);
